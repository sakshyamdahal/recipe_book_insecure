...
<?php include("includes/header.php"); ?>
		...
		<div class="parallax text-center" style="background-image: url(http://wowthemes.net/demo/leroy/img/dummy1.jpg);">
			<div class="parallax-pattern-overlay">
				<div class="container text-center" style="height:580px;padding-top:170px;">
					...
					<h2 class="intro wow zoomIn" wow-data-delay="0.4s" wow-data-duration="0.9s" style="color:green;">Secure Site</h2>
				</div>
			</div>
		</div>
	</div>	
	...
	<div class="container">
		<div class="heading text-center">
			...
			prepare that special meal for your special one. And don't worry about security let us handle that. &#9786;  &#9786;  &#9786;  &#9786;  &#9786;
			</h3>
		</div>			
	</div>
	</section>
